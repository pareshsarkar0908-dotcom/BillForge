...
- Monthly pricing flow that sends new users to create an account before subscribing
- Razorpay payment buttons labelled "Subscribe"
...
- Dark mode with a saved user preference and system-theme fallback
